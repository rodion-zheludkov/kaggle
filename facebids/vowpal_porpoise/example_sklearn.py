...
from vp_sklearn import VW_Classifier
...
def main():
    ...
    clf = VW_Classifier(loss='logistic', moniker='example_sklearn',
                        passes=10, silent=True, learning_rate=10)

    skf = StratifiedKFold(y, 5)
    print cross_validation.cross_val_score(clf, X, y, scoring='roc_auc', cv=skf)
