...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   THIS PROGRAM IS AN EXCERPT FROM THE TIME-FREQUENCY TOOLBOX     %
%%   available at http://crttsn.univ-nantes.fr/~auger/tftb.html.    %
%%   It is used with the kind permission of its author F. Auger     %
%%   (e-mail: f.auger@ieee.org).                                    %
