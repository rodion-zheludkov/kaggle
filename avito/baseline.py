...
dataFolder = "/home/rodion/avito/traindata/"
...
def getItems(fileName, itemsLimit=None):
    ...
    with open(os.path.join(fileName)) as items_fd:
...
def processData(fileName, featureIndexes={}, itemsLimit=None):
    """ Processing data. """
    processMessage = ("Generate features for " if featureIndexes else "Generate features dict from ") \
